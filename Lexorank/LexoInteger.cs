...
public class LexoInteger : IComparable<LexoInteger>, IComparable
{
    ...
    public LexoInteger Negate() => IsZero() ? this : Make(_sys, _sign == 1 ? -1 : 1, _mag);
    ...
    public LexoInteger Complement() => Complement(_mag.Length);

    private LexoInteger Complement(int digits) => Make(_sys, _sign, Complement(_sys, _mag, digits));
    ...
    private bool IsOneish() => _mag.Length == 1 && _mag[0] == 1;
    ...
    public ILexoNumeralSystem GetSystem() => _sys;
    ...
    private bool Equals(LexoInteger other) => _sys == other._sys && CompareTo(other) == 0;
